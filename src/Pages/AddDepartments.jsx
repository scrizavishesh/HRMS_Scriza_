...
import { departmentAdd } from '../utils/Constants';
...
const AddDepartments = () => {
    ...
    const handleParentDepartment = (value) => {
        setParentDepartment(value);
    }

    const handleDepartmentStatus = (value) => {
        setDepartmentStatus(value);
    }

    const AddDepartment = async (e) => {

        if ((departmentName !== "", ParentDepartment !== "", SelectManager !== "", DepartmentStatus !== "")) {
            const formData = new FormData();
            formData.append("department_name", departmentName);
            formData.append("manager", SelectManager);
            formData.append("parent_department", ParentDepartment);
            formData.append("status", DepartmentStatus);
            try {
                const response = await departmentAdd(formData);
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-12 p-4" style={{ background: "#fff" }}>
                        <Forms>
                            <form>
                                <h5 className='heading'>Employee Department:</h5>
                                <br />
                                <div className="row">
                                    <div className="col-md-3 col-12">
                                        <div className="mb-3">
                                            <label htmlFor="exampleInputEmail1" className="form-label sub-heading">Department name*</label>
                                            <input onChange={(e) => handleDepartmentName(e.target.value)} type="text" placeholder='Department name*' className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                                        </div>
                                    </div>
                                    <div className="col-md-3 col-12">
                                        <div className="mb-3">
                                            <label className="form-label sub-heading">Select Manager*</label>
                                            <select onChange={(e) => handleSelectManager(e.target.value)} class="form-select">
                                                <option>-----Select Manager*----</option>
                                                <option value="Sunil">Sunil</option>
                                                <option value="Alok Sharma">Alok Sharma</option>
                                                <option value="Mugal Joshi">Mugal Joshi</option>
                                                <option value="Metha Rathi">Metha Rathi</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div className="col-md-3 col-12">
                                        <div className="mb-3">
                                            <label htmlFor="exampleInputEmail1" className="form-label sub-heading">Parent Department</label>
                                            <input onChange={(e) => handleParentDepartment(e.target.value)} type="text" className="form-control" placeholder='Parent Department' id="exampleInputEmail1" aria-describedby="emailHelp" />
                                        </div>
                                    </div>
                                    <div className="col-md-3 col-12">
                                        <div className="mb-3">
                                            <label htmlFor="exampleInputEmail1" className="form-label sub-heading">Department Status*</label>
                                            <select onChange={(e) => handleDepartmentStatus(e.target.value)} class="form-select">
                                                    <option>-----Select Manager*----</option>
                                ...
                                <div className="row">
                                    <div className='d-flex justify-content-center'>
                                        ...
                                        <button type="button" className="btn btn-warning" onClick={AddDepartment}>Save</button>
                                    </div>
                                </div>
                            </form>
                        </Forms>
